...
<section class="home">
	<article class="mbox">
		...
		<!--<div class="mtabt">
			<ul class="cl">
            <?php if(is_array($erjicaidan)): $i = 0; $__LIST__ = $erjicaidan;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('mobile/anli',array('type_id'=>$vo["id"])); ?>"><?php echo ($vo["type_name"]); ?></a></li>
		...
		<!--<h3><span class="cred"><?php echo ($mymodualNtype["type_name"]); ?></span></h3>-->

		
		<ul class="mlist cl" style="">
<?php if(is_array($thislist2)): $i = 0; $__LIST__ = $thislist2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('mobile/anli_show',array('id'=>$vo['id'])); ?>"><img src="/timthumb.php?src=<?php echo ($vo["product_pic_s"]); ?>&h=286&w=390&zc=2" alt="<?php echo ($vo["product_title"]); ?>"><h6><?php echo (msubstr($vo["product_title"],0,29,"utf-8",true)); ?></h6></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
