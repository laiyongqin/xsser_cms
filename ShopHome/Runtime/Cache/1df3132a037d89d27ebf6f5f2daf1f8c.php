...
<?php }?>
		<div class="pright">
			...
			<div class="probox">
				<ul class="plist cl">
<?php if(is_array($thislist2)): $i = 0; $__LIST__ = $thislist2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('index/anli_show',array('id'=>$vo['id'])); ?>" class="pic"><img src="/timthumb.php?src=<?php echo ($vo["product_pic_s"]); ?>&h=300&w=303&zc=2" height="300" width="303" ></a><h5><a href="<?php echo U('index/anli_show',array('id'=>$vo['id'])); ?>"><?php echo (msubstr($vo["product_title"],0,29,"utf-8",true)); ?></a></h5></li><?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
				<div class="pages">
				<?php echo ($page); ?>
				</div>
