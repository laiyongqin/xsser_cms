...
<volist name="thislist" id="vo" > 
				<li class="cl">
					<div class="npic"><a href="<php>echo U('index/news_show',array('id'=>$vo['id']));</php>"><img src="/timthumb.php?src={$vo.product_pic_s}&h=167&w=250&zc=2" height="167" width="250" alt="{$vo.product_title }"></a></div>
					<div class="ninfo">
