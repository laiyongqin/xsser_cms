    ...
    <div class="box gradient span12">
     ...
     <!--  -->
        ...
        <div class="box gradient">
          ...
          <div class="content">
            <form class="form-horizontal row-fluid" action="<?php echo U("ConfigAdmin/update");?>" method="post">
              <div class="form-row control-group row-fluid">
                <label class="control-label span3" for="normal-field">账户名字*</label>
                <div class="controls span7">
                  <input type="text" id="disabled-input" class="row-fluid" disabled="disabled" value="<?php echo ($mymodual["admin_user"]); ?>" name="admin_user">
                </div>
              </div>
             <div class="form-row control-group row-fluid">
              ...
              <select  class="chzn-select" id="default-select" name="admin_power_id">
                    <?php if(is_array($cpower_list)): $i = 0; $__LIST__ = $cpower_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>"  <?php if(($vo["id"]) == $mymodual["admin_power"]): ?>selected="selected"<?php endif; ?> ><?php echo ($vo["name"]); ?>|<?php echo ($vo["rank"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                  </select>
                </div>
              </div>
              <?php } ?>
