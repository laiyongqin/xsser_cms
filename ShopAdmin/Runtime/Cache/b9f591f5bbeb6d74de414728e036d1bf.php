    ...
    <div class="box gradient span12">
     ...
     <!--  -->
        ...
        <div class="box gradient">
          ...
          <div class="content">
            <form class="form-horizontal row-fluid" action="<?php echo U("ConfigConf/update");?>" method="post">
              <div class="form-row control-group row-fluid">
                <label class="control-label span3" for="normal-field">全局参数名字*</label>
                <div class="controls span7">
                  <input type="text" id="normal-field" class="row-fluid" readonly="readonly" name="conf" value="<?php echo ($mymodual["conf"]); ?>">
                </div>
              </div>
             <div class="form-row control-group row-fluid">
                <label class="control-label span3" for="normal-field">全局参数赋值*</label>
                <div class="controls span7">
                  <textarea rows="3" class="row-fluid autogrow" id="elastic-textarea"  name="value" ><?php echo ($mymodual["value"]); ?></textarea>
                </div>
              </div>
              <div class="form-row control-group row-fluid">
                <label class="control-label span3" for="normal-field">全局参数说明</label>
                <div class="controls span7">
                  <textarea rows="3" class="row-fluid autogrow" id="elastic-textarea"  name="bak1" ><?php echo ($mymodual["bak1"]); ?></textarea>
                </div>
              </div>
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span9">
                    ...
                    <input type="text"  class="span5" name="bak2" id="upload_product_type" value="<?php echo ($mymodual["bak2"]); ?>">
