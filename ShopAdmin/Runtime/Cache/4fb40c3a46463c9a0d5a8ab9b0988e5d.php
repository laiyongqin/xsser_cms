    ...
    是否显示
            ...
            <?php if(is_array($thislist)): $i = 0; $__LIST__ = $thislist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td class="ms">
                <div class="btn-group1">
                  <a class="btn btn-small" rel="tooltip" data-placement="left" data-original-title=" edit "  href="<?php echo U("ConfigNewstype/update_info");?>?id=<?php echo ($vo["id"]); ?>"><i class="gicon-edit"></i></a>
     ...
     <!--  -->
        ...
        <div class="box gradient">
          ...
          <div class="content">
            <form class="form-horizontal row-fluid" action="<?php echo U("ConfigNewstype/add");?>" method="post">
