...
<div class="row-fluid">
      ...
      <div class="title">
        ...
        <div class="content">
          <ul id="tabExample1" class="nav nav-tabs">
                                    ...
                                    <li><a href="#profile2" data-toggle="tab">增加</a></li>
           </ul>
    ...
    关联
            ...
            <?php if(is_array($thislist)): $i = 0; $__LIST__ = $thislist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td class="to_hide_phone">
                ...
                <?php $param_array=split('[|]',$vo['param']); ?> 
                <?php if(trim($param_array[0])!=""&&strlen($param_array[0])<40&&strlen($param_array[0])>35){ ?><img  src="<?php echo ($param_array[0]); ?>" width="120" height="100"><?php } ?>
              </td>
              <td class="to_hide_phone">
              ...
              <td class="ms">
                <div class="btn-group1">
                  <a class="btn btn-small" rel="tooltip" data-placement="left" data-original-title=" 修改"   href="<?php echo U("OtherProduct/update_info");?>?id=<?php echo ($vo["id"]); ?>"><i class="gicon-edit"></i></a>
                  <a class="btn btn-inverse btn-small" rel="tooltip" data-placement="bottom" data-original-title="删除"  onclick="if(confirm('确认删除吗?')) window.location='<?php echo U("OtherProduct/del");?>?id=<?php echo ($vo["id"]); ?>'"><i class="gicon-remove icon-white"></i></a>
                </div>
              </td>
   ...
   <!--  -->
        ...
        <div class="box gradient">
          ...
          <div class="content">
            <form class="form-horizontal row-fluid" action="<?php echo U("OtherProduct/add");?>" method="post">
