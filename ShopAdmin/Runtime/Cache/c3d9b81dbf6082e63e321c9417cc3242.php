...
<div class="row-fluid">
      ...
      <div class="title">
        ...
        <div class="content">
          <ul id="tabExample1" class="nav nav-tabs">
                                    ...
                                    <li><a href="#profile2" data-toggle="tab">增加新闻</a></li>
           </ul>
   ...
   <div id="container2">
    ...
    排序
            ...
            <?php if(is_array($thislist)): $i = 0; $__LIST__ = $thislist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td>
                <?php echo (date('Y-m-d',$vo["news_time"])); ?>
              </td>
              <td class="to_hide_phone">
               <!--<?php echo ($vo["view_count"]); ?>-->
                <?php if(trim($vo['bak1'])!=""){ ?><img  src="<?php echo ($vo["bak1"]); ?>" width="120" height="100"><?php } ?>
              </td>
              <td class="to_hide_phone">
               <?php if(($vo["active"]) == "1"): ?><font style="color: blue;">已审核</font><?php endif; if(($vo["active"]) == "0"): ?><font style="color: red;">未审核</font><?php endif; ?>
              </td>
              <td class="to_hide_phone">
               <?php if(($vo["news_reco"]) == "1"): ?><font style="color: blue;">推荐</font><?php endif; if(($vo["news_reco"]) == "0"): ?><font style="color: red;">不推荐</font><?php endif; ?>
              </td>
               <td class="to_hide_phone">
              ...
              <td class="ms">
                <div class="btn-group1">
                  <a class="btn btn-small" rel="tooltip" data-placement="left" data-original-title=" 修改"  href="<?php echo U("News/update_info");?>?id=<?php echo ($vo["id"]); ?>"><i class="gicon-edit"></i></a>
                  <a class="btn btn-inverse btn-small" rel="tooltip" data-placement="bottom" data-original-title="删除"  onclick="if(confirm('确认删除吗?')) window.location='<?php echo U("News/del");?>?id=<?php echo ($vo["id"]); ?>'"><i class="gicon-remove icon-white"></i></a>
                </div>
              </td>
   ...
   <!--  -->
        ...
        <div class="box gradient">
          ...
          <div class="content">
            <form class="form-horizontal row-fluid" action="<?php echo U("News/add");?>" method="post">
              ...
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span7">
                  <input type="text" id="normal-field" class="row-fluid" name="news_title"  >
                </div>
              </div>
              <div class="form-row control-group row-fluid">
                <label class="control-label span2" for="normal-field">内容*</label>
                <div class="controls span7">
                  <textarea  id="mydefault-textarea" name="news_content"></textarea>
              ...
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span6">
                  ...
                  <input type="radio" name="news_reco" value="1"  /> 是</label>
                  <label class="inline radio">
                  <input type="radio" name="news_reco" value="0"  checked="CHECKED"  /> 否 </label>
                </div>
              </div>
              <div class="form-row control-group row-fluid">
                <label class="control-label span2" for="normal-field">发布人</label>
                <div class="controls span3">
                  <input type="text" id="normal-field" class="row-fluid" name="news_user" value="<?php echo ($news_user); ?>" >
                </div>
              </div>
             <!--
             <div class="form-row control-group row-fluid">
                ...
                <div class="controls span3">
                  <div class="input-append date row-fluid" id="datepicker2" data-date="<?php echo date('Y-m-d',time()); ?>" data-date-format="yyyy-mm-dd">
                    <input type="text" value="<?php echo date('Y-m-d',time()); ?>" class="row-fluid"  name="news_time">
