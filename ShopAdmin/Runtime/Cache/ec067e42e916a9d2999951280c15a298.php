      ...
      <div class="row-fluid">
        <div class="span12">
          <div class="box gradient">
            <div class="title">
              <h4>
              <i class="icon-globe"></i><span>系统信息</span>
              </h4>
            </div>
            <!-- End .title -->
            <div class="content">
              ...
              <tr>
                ...
                <td class="ms">
                 <span style="float: left;"> <?php echo php_uname(); ?></span>
                </td>
                <!--<th class="Yy to_hide_phone">
                  % Visits
                </th>-->
              ...
              <tr>
                ...
                <td class="ms">
                  <span style="float: left;"> <?php echo php_sapi_name(); ?></span>
                </td>
                <!--<th class="Yy to_hide_phone">
                  % Visits
                </th>-->
              ...
              <tr>
                ...
                <td class="ms">
                <span style="float: left;"> <?php echo PHP_VERSION; ?></span>
                </td>
                <!--<th class="Yy to_hide_phone">
                  % Visits
                </th>-->
              ...
              <tr>
                ...
                <td class="ms">
                  <span style="float: left;"> <?php echo APP_WEB_ROOT; ?></span>
                </td>
                <!--<th class="Yy to_hide_phone">
                  % Visits
                </th>-->
             ...
             <tr>
                ...
                <td class="ms">
                  <span style="float: left;"><?php $config=C("XSSER_MY_UP_FILE"); echo $config['savePath']; ?></span>
                </td>
                <!--<th class="Yy to_hide_phone">
                  % Visits
                </th>-->
              ...
              <tr>
                ...
                <td class="ms">
                  <span style="float: left;"><?php $config=C("DB_HOST"); echo $config; ?></span>
                </td>
                <!--<th class="Yy to_hide_phone">
                  % Visits
                </th>-->
              ...
              <tr>
                ...
                <td class="ms">
                 <span style="float: left;"> <?php echo $getsysinfo_title['value']; ?></span>
                </td>
                <!--<th class="Yy to_hide_phone">
                  % Visits
                </th>-->
                ...
                <td class="ms">
                 <span style="float: left;"> <?php echo $getsysinfo_keywords['value']; ?></span>
                </td>
                <!--<th class="Yy to_hide_phone">
                  % Visits
                </th>-->
                ...
                <td class="ms">
                 <span style="float: left;"> <?php echo $getsysinfo_description['value']; ?></span>
                </td>
                <!--<th class="Yy to_hide_phone">
                  % Visits
                </th>-->
   ...
   <div class="row-fluid">
        <div class="span12">
          <div class="box gradient">
            <div class="title">
              <h4>
              <i class="icon-globe"></i><span>组件支持检测</span>
              </h4>
            </div>
            <!-- End .title -->
            <div class="content">
              <table id="datatable_example" class="responsive table table-striped" style="width:100%;height:300px;margin-bottom:0; ">
              <thead>
<?php $YES='<span style="color: #008000; font-weight : bold;">Yes</span>'; $NO='<span style="color: #ff0000; font-weight : bold;">No</span>'; function get_gd_info($name) { $gd_info = gd_info(); return $gd_info[$name]; } ?>
              ...
              <tr>
                ...
                <td class="ms">
                 <span style="float: left;"> <?php echo function_exists('mysql_close') ? $YES.' / client lib version '.mysql_get_client_info() : $NO ?></span>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td class="ms">
                 <span style="float: left;"> <?php echo function_exists('gd_info') ? $YES.' / '.get_gd_info('GD Version') : $NO ?></span>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td class="ms">
                 <span style="float: left;"> <?php echo function_exists('fsockopen') ? $YES : $NO ?></span>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td class="ms">
                 <span style="float: left;"> <?php echo function_exists('curl_init') ? $YES : $NO ?></span>
                </td>
              </tr>
