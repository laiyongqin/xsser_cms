      ...
      <div class="title">
        ...
        <div class="content">
          <ul id="tabExample1" class="nav nav-tabs">
                                    <li class="active"><a href="#home1" data-toggle="tab">优惠券发放记录</a></li>
           </ul>
          ...
          <div class="content top">
            ...
            <?php if(is_array($thislist)): $i = 0; $__LIST__ = $thislist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
             ...
             <?php echo (date("Y-m-d H:i:s",$vo["ftime"])); ?>
              ...
              <td class="to_hide_phone">
               <?php if(($vo["is_use"]) != "0"): ?><span style="color: red;">已经使用</span><?php endif; if(($vo["is_use"]) != "1"): ?><span style="color:green;">未使用</span><?php endif; ?>
              </td>
              <td class="to_hide_phone">
               <?php echo (getadmin_name($vo["admin_id"])); ?>
              </td>              
              <td class="to_hide_phone">
               <?php echo (getuser_name($vo["user_id"])); ?>
              </td>
