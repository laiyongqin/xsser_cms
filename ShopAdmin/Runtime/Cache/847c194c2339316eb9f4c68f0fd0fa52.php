...
<div class="row-fluid">
    <div class="box gradient span12">
      <div class="title">
            <div class="row-fluid">
                <h3>
                  <i class=" icon-bar-chart"></i> 高级自定义栏目类别管理
                </h3>
            </div>
        </div><!-- End .title -->
   ...
   <div id="container2">
        ...
        <div class="span12 box gradient ">
          ...
          <div class="content top">
           ...
           显示
             ...
             <th  class="no_sort" style="width: 188px;">
             属性显示名
              </th>
              <th class="no_sort" style="width: 188px;">
             属性类型
            ...
            <?php if(is_array($thislist)): $i = 0; $__LIST__ = $thislist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td class="ms">
                <div class="btn-group1">
                  <a class="btn btn-small" rel="tooltip" data-placement="left" data-original-title=" edit "  href="<?php echo U("ConfigProducttypegaoji/update_info");?>?id=<?php echo ($vo["id"]); ?>"><i class="gicon-edit"></i></a>
                  <a class="btn btn-inverse btn-small" rel="tooltip" data-placement="bottom" data-original-title="Remove"  onclick="if(confirm('确认删除吗?如果要删除的项存在子类不会删除成功哦!')) window.location='<?php echo U("ConfigProducttypegaoji/del");?>?id=<?php echo ($vo["id"]); ?>'"><i class="gicon-remove icon-white"></i></a>
                </div>
              </td>
     ...
     <!--  -->
        ...
        <div class="box gradient">
          ...
          <div class="content">
            <form class="form-horizontal row-fluid" action="<?php echo U("ConfigProducttypegaoji/add");?>" method="post">
