      ...
      <div class="title">
        ...
        <div class="content">
          <ul id="tabExample1" class="nav nav-tabs">
                                    <li class="active"><a href="#home1" data-toggle="tab">拥有的优惠券</a></li>
                                    <li><a href="#profile2" data-toggle="tab">给 [<?php echo getuser_name($_GET['id']); ?>] 发放优惠券</a></li>
           </ul>
   ...
   <div id="container2">
      <div class="row-fluid ">
        <div class="span12 box gradient ">
          ...
          <div class="content top">
            ...
            <?php if(is_array($thislist)): $i = 0; $__LIST__ = $thislist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              <td>
                <?php echo (getcoupon_name($vo["coupon_id"])); ?>
              </td>
              <td class="to_hide_phone">
             <?php echo (date("Y-m-d H:i:s",$vo["ftime"])); ?>
              </td>
              <td class="to_hide_phone">
               <?php if(($vo["is_use"]) != "0"): ?>已经使用<?php endif; if(($vo["is_use"]) != "1"): ?>未使用<?php endif; ?>
              </td>

              <td class="ms">
                <div class="btn-group1">
                  <a class="btn btn-inverse btn-small" rel="tooltip" data-placement="bottom" data-original-title="删除优惠券"  onclick="if(confirm('确认删除这条优惠券信息吗,不要轻易删除用户的数据哦?')) window.location='<?php echo U("ShopUser/delusercoupon");?>?id=<?php echo ($vo["id"]); ?>'"><i class="gicon-remove icon-white"></i></a>
                </div>
              </td>
        ...
        <div class="box gradient">
          ...
          <div class="content">
            <form class="form-horizontal row-fluid" action="<?php echo U("ShopUser/addusercoupon");?>" method="post">
              <div class="form-row control-group row-fluid">
                <label class="control-label span3" for="default-select">选择优惠券*</label>
                <div class="controls span7">
                  <select  class="chzn-select" id="default-select" name="coupon_id">
