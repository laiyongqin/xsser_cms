      ...
      <div class="title">
        ...
        <div class="content">
          <ul id="tabExample1" class="nav nav-tabs">
                                    <li class="active"><a href="#home1" data-toggle="tab">为管理组中【<?php echo ($mymodual["name"]); ?>】这个组配置模块权限</a></li>
           </ul>
            ...
            <?php if(is_array($thislist)): $i = 0; $__LIST__ = $thislist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td class="ms">
                <div class="btn-group1">
                  <form class="form-horizontal row-fluid" action="<?php echo U("ConfigAdmin/quanxian_module_update");?>" method="post">
                  <input type="hidden" name="power_id" value="<?php echo ($mymodual["id"]); ?>" />
                  <input type="hidden" name="module_id" value="<?php echo ($vo["id"]); ?>" />
                  <input type="checkbox" value="<?php $temp_this_view=getadmin_quanxian_caozuomodule($mymodual['id'],$vo['id']); echo $temp_this_view; ?>" name="view[]" <?php if ($temp_this_view==1){echo 'checked="CHECKED"';} ?> >管理权</label>
