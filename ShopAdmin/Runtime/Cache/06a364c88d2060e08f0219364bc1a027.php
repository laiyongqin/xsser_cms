...
<div class="row-fluid">
    <div class="box gradient span12">
      <div class="title">
            <div class="row-fluid">
                <h3>
                  <i class=" icon-bar-chart"></i> 其他自定义信息管理
                </h3>
            </div>
        </div><!-- End .title -->
       ...
       <!--  -->
        ...
        <div class="box gradient">
          ...
          <div class="content">
            <form class="form-horizontal row-fluid" action="<?php echo U("OtherProduct/update");?>" method="post">
              ...
              <div class="form-row control-group row-fluid">
                <label class="control-label span2" for="normal-field"><?php echo $muxing_shuxing_name[$i]; ?></label>
                <div class="controls span7">
                  <textarea rows="3" class="row-fluid autogrow" id="elastic-textarea"  name="param<?php echo $i; ?>" >
                  <?php $abtext=htmlspecialchars_decode($param_array[$i]); ?>
                   <?php echo (str_replace('\"','"',$abtext)); ?>
                  </textarea>
                </div>
              </div>
			...
			<div class="form-row control-group row-fluid">
                <label class="control-label span2" for="normal-field"><?php echo $muxing_shuxing_name[$i]; ?></label>
                <div class="controls span7">
                  <textarea  id="mydefault-textarea<?php echo $i; ?>" name="param<?php echo $i; ?>" ><?php echo ($param_array[$i]); ?></textarea>
