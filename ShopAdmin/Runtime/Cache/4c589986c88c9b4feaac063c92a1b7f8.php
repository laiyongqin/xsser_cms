      ...
      <div class="title">
        ...
        <div class="content">
          <ul id="tabExample1" class="nav nav-tabs">
                                    <li class="active"><a href="#home1" data-toggle="tab">类别管理</a></li>
   ...
   <div id="container2">
        ...
        <div class="span12 box gradient ">
          ...
          <div class="content top">
           ...
           显示
             ...
             <th  class="no_sort" style='width: 188px;word-break: break-all;word-wrap: break-word;'>
             属性显示名
              </th>
              <th class="no_sort" style='width: 188px;word-break: break-all;word-wrap: break-word;'>
             属性类型
            ...
            <?php if(is_array($thislist)): $i = 0; $__LIST__ = $thislist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td  style='width: 188px;word-break: break-all;word-wrap: break-word;'>
              ...
              <td class="ms">
                <div class="btn-group1">
                  <a class="btn btn-small" rel="tooltip" data-placement="left" data-original-title=" edit "  href="<?php echo U("ConfigProducttype/update_info");?>?id=<?php echo ($vo["id"]); ?>"><i class="gicon-edit"></i></a>
                  <a class="btn btn-inverse btn-small" rel="tooltip" data-placement="bottom" data-original-title="Remove"  onclick="if(confirm('确认删除吗?如果要删除的项存在子类不会删除成功哦!')) window.location='<?php echo U("ConfigProducttype/del");?>?id=<?php echo ($vo["id"]); ?>'"><i class="gicon-remove icon-white"></i></a>
                </div>
              </td>
     ...
     <!--  -->
        ...
        <div class="box gradient">
          ...
          <div class="content">
            <form class="form-horizontal row-fluid" action="<?php echo U("ConfigProducttype/add");?>" method="post">
              <div class="form-row control-group row-fluid">
                <label class="control-label span3" for="normal-field">类型名称*</label>
                <div class="controls span7">
                  <input type="text" id="normal-field" class="row-fluid" name="type_name">
                </div>
              </div>
              <div class="form-row control-group row-fluid">
                <label class="control-label span3" for="normal-field">类型类别*</label>
                <div class="controls span3">
                  <input type="text" id="normal-field" class="row-fluid" name="type_type">
                </div>
              ...
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span7">
                  <select  class="chzn-select" id="default-select" name="type_parent">
                    ...
                    <?php if(is_array($type_list)): $i = 0; $__LIST__ = $type_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>" ><?php if(($vo["type_rank"]) != "1"): echo (str_chengfa_nbsp($vo['type_rank'])); ?>| --<?php endif; echo ($vo["type_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    <?php ?>
                  </select>
                </div>
              </div>
              ...
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span6">
                  <label class="inline radio">
                  <input type="radio" name="isshow" value="1" checked="CHECKED"/> 是</label>
                  <label class="inline radio">
                  <input type="radio" name="isshow" value="0" /> 否 </label>
                </div>
              </div>
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span9">
                    ...
                    <input type="text"  class="span5" name="bak1" id="upload_product_type">
             ...
             <div class="form-row control-group row-fluid">
              ...
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span9">
                  ...
                  <?php if(is_array($pt_list)): $i = 0; $__LIST__ = $pt_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["modual_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
