...
<div class="row-fluid">
            ...
            <?php if(is_array($thislist)): $i = 0; $__LIST__ = $thislist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td class="ms">
                <div class="btn-group1">
                  <a class="btn btn-small" rel="tooltip" data-placement="left" data-original-title=" 修改"   href="<?php echo U("Product/update_info");?>?id=<?php echo ($vo["id"]); ?>"><i class="gicon-edit"></i></a>
                  <a class="btn btn-inverse btn-small" rel="tooltip" data-placement="bottom" data-original-title="删除"  onclick="if(confirm('确认删除吗?')) window.location='<?php echo U("Product/del");?>?id=<?php echo ($vo["id"]); ?>'"><i class="gicon-remove icon-white"></i></a>
                </div>
              </td>
   ...
   <!--  -->
        ...
        <div class="box gradient">
          ...
          <div class="content">
            <form class="form-horizontal row-fluid" action="<?php echo U("Product/add");?>" method="post">
		...
		$('#file_param<?php echo $i; ?>').uploadify({
			 ...
			 <div class="form-row control-group row-fluid">
              ...
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span6">
                  <label class="inline radio">
                  <input type="radio" name="product_reco" value="1"  /> 是</label>
                  <label class="inline radio">
                  <input type="radio" name="product_reco" value="0"  checked="CHECKED"  /> 否 </label>
                </div>
              </div>
              <div class="form-row control-group row-fluid">
