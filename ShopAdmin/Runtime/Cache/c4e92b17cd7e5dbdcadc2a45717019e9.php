...
<div class="row-fluid">
    <div class="box gradient span12">
      <div class="title">
            <div class="row-fluid">
                <h3>
                  <i class=" icon-bar-chart"></i> 产品(普通自定义)信息管理
                </h3>
            </div>
        </div><!-- End .title -->
        ...
        <div class="content">
          <ul id="tabExample1" class="nav nav-tabs">
                                    <li class="active"><a href="#home1" data-toggle="tab">修改产品</a></li>
           </ul>
       ...
       <!--  -->
        ...
        <div class="box gradient">
          ...
          <div class="content">
            <form class="form-horizontal row-fluid" action="<?php echo U("Product/update");?>" method="post">
              ...
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span7">
                  <input type="text" id="normal-field" class="row-fluid" name="product_title"  value="<?php echo ($mymodual["product_title"]); ?>">
                </div>
              </div>
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span9">
                    ...
                    <input type="text"  class="span5" name="product_pic_s" id="upload_product_pic_s"   value="<?php echo ($mymodual["product_pic_s"]); ?>" >
		...
		$('#file_product_pic_s').uploadify({
              ...
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span9">
                    ...
                    <input type="text"  class="span5" name="product_pic_b" id="upload_product_pic_b"   value="<?php echo ($mymodual["product_pic_b"]); ?>">
		...
		$('#file_product_pic_b').uploadify({
	        	...
	        	'onUploadSuccess' : function(file, data, response) {
	        	 ...
	        	 if(jsonimg.status==0){
              	...
              	<?php $param_array=split('[|]',$mymodual['param']); if( strlen($muxing_shuxing_name)>0 && strlen($muxing_shuxing_type)>0) { for($i=0;$i<count($muxing_shuxing_name);$i++) { if($muxing_shuxing_type[$i]=="text") { ?>
			  <div class="form-row control-group row-fluid">
                <label class="control-label span2" for="normal-field"><?php echo $muxing_shuxing_name[$i]; ?></label>
                <div class="controls span7">
                  <input type="text" id="normal-field" class="row-fluid" name="param<?php echo $i; ?>"   value="<?php echo ($param_array[$i]); ?>" >
                </div>
              </div>
              ...
              <div class="form-row control-group row-fluid">
                <label class="control-label span2" for="normal-field"><?php echo $muxing_shuxing_name[$i]; ?></label>
                <div class="controls span7">
                  <textarea rows="3" class="row-fluid autogrow" id="elastic-textarea"  name="param<?php echo $i; ?>" ><?php echo ($param_array[$i]); ?></textarea>
                </div>
              </div>
			...
			<div class="form-row control-group row-fluid">
                <label class="control-label span2" for="normal-field"><?php echo $muxing_shuxing_name[$i]; ?></label>
                <div class="controls span7">
                  <textarea  id="mydefault-textarea<?php echo $i; ?>" name="param<?php echo $i; ?>" ><?php echo (str_replace('\"','"',$param_array[$i])); ?></textarea>
			...
			<div class="form-row control-group row-fluid">
                ...
                <div class="controls span9">
                    ...
                    <input type="text"  class="span5" name="param<?php echo $i; ?>" id="upload_param<?php echo $i; ?>"   value="<?php echo ($param_array[$i]); ?>"  >
		...
		$('#file_param<?php echo $i; ?>').uploadify({
			  ...
			  <div class="form-row control-group row-fluid">
                ...
                <div class="controls span6">
                  ...
                  <input type="radio" name="param<?php echo $i; ?>" value="1"  <?php if(($param_array[$i]) == "1"): ?>checked="CHECKED"<?php endif; ?> /> 是</label>
                  <label class="inline radio">
                  <input type="radio" name="param<?php echo $i; ?>" value="0"  <?php if(($param_array[$i]) == "0"): ?>checked="CHECKED"<?php endif; ?>  /> 否 </label>
                </div>
              </div>
									<?php } else { ?>
			 <div class="form-row control-group row-fluid">
              ...
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span7">
                  <textarea  id="mydefault-textarea" name="product_content"><?php echo (str_replace('\"','"',$mymodual["product_content"])); ?></textarea>
                  <script type="text/javascript">    
              ...
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span6">
                  <label class="inline radio">
                  <input type="radio" name="product_reco" value="1"   <?php if(($mymodual["product_reco"]) == "1"): ?>checked="CHECKED"<?php endif; ?> /> 是</label>
                  <label class="inline radio">
                  <input type="radio" name="product_reco" value="0"   <?php if(($mymodual["product_reco"]) == "0"): ?>checked="CHECKED"<?php endif; ?>  /> 否 </label>
                </div>
              </div>
              <div class="form-row control-group row-fluid">
                <label class="control-label span2" for="normal-field">发布人</label>
                <div class="controls span3">
                  <input type="text" id="normal-field" class="row-fluid" name="product_user" value="<?php echo ($mymodual["product_user"]); ?>" >
                </div>
              </div>
             <div class="form-row control-group row-fluid">
                <label class="control-label span2" for="normal-field">发布时间*</label>
                <div class="controls span3">
                  <div class="input-append date row-fluid" id="datepicker2" data-date="<?php echo (date('Y-m-d',$mymodual["product_time"])); ?>" data-date-format="yyyy-mm-dd">
                    <input type="text" value="<?php echo (date('Y-m-d',$mymodual["product_time"])); ?>" class="row-fluid"  name="product_time">
              ...
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span3">
                  <input type="text" id="disabled-input" class="row-fluid" disabled="disabled" value="<?php echo (date('Y-m-d H:i:s',$mymodual["product_modify_time"])); ?>">
                </div>
              </div>
              <div class="form-row control-group row-fluid">
                <label class="control-label span2" for="normal-field">查看次数*</label>
                <div class="controls span3">
                  <input type="text" id="normal-field" class="row-fluid"   name="view_count" value="<?php echo ($mymodual["view_count"]); ?>">
                </div>
              </div>
              ...
              <div class="form-row control-group row-fluid ">
                ...
                <div class="controls span7">
                  <?php if(is_array($this_type_list_tuijian)): $i = 0; $__LIST__ = $this_type_list_tuijian;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class="checkbox"><!-- checkbox inline -->
                     <input type="checkbox"   <?php  $isin = in_array($vo["id"],$tuijian_id_group); if($isin){ echo ("checked"); } ?>   <?php if(($vo["id"]) == $mymodualNtype["id"]): ?>disabled="true"<?php endif; ?>   value="<?php echo ($vo["id"]); ?>" name="tuijian_id_group[]"><?php if(($vo["type_rank"]) != "1"): echo (str_chengfa_nbsp($vo['type_rank'])); ?>| --<?php endif; echo ($vo["type_name"]); ?></label><?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
              </div>
              <div class="form-actions row-fluid">
                <div class="span7 offset3">
                  <input type="hidden" name="id" value="<?php echo ($mymodual["id"]); ?>" >
                  <input type="hidden" name="type_id" value="<?php echo ($mymodualNtype["id"]); ?>" >
