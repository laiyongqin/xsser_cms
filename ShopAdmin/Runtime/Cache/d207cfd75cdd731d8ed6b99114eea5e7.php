...
<div class="row-fluid">
      ...
      <div class="title">
        ...
        <div class="content">
          <ul id="tabExample1" class="nav nav-tabs">
                                    <li class="active"><a href="#home1" data-toggle="tab">修改单页</a></li>
           </ul>
        ...
        <div class="box gradient">
          ...
          <div class="content">
            <form class="form-horizontal row-fluid" action="<?php echo U("DanyeNews/update");?>" method="post">
              ...
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span7">
                  <textarea  id="mydefault-textarea" name="news_content">
                  
                  <?php $abtext= htmlspecialchars_decode($mymodual['news_content']); ?>
              ...
              <div class="form-row control-group row-fluid">
                ...
                <div class="controls span3">
                  <input type="text" id="disabled-input" class="row-fluid" disabled="disabled" value="<?php echo ($mymodual["view_count"]); ?>"  name="view_count">
                </div>
              </div>
   ...
   <script>
		...
		$('#file_upload_product_type').uploadify({
	        	...
	        	//'uploader' : '<?php echo U("Index/qiniu_uploadfile");?>',   //上传的方法
	        	'buttonText' : '图片上传',
