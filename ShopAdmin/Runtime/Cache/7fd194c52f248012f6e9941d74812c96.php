...
<div class="row-fluid">
      ...
      <div class="title">
        ...
        <div class="content">
          <ul id="tabExample1" class="nav nav-tabs">
                                    <li class="active"><a href="#home1" data-toggle="tab">修改模型</a></li>
           </ul>
   ...
   <!--  -->
        ...
        <div class="box gradient">
          ...
          <div class="content">
            <form class="form-horizontal row-fluid" action="<?php echo U("ConfigModual/update");?>" method="post">
              <div class="form-row control-group row-fluid">
                <label class="control-label span3" for="normal-field">模型名字*</label>
                <div class="controls span7">
                  <input type="text" id="normal-field" class="row-fluid" name="modual_name" value="<?php echo ($mymodual["modual_name"]); ?>">
                </div>
              </div>
              <div class="form-row control-group row-fluid">
                <label class="control-label span3" for="normal-field">属性显示名字*</label>
                <div class="controls span7">
                  <input type="text" id="normal-field" class="row-fluid" name="shuxing_name" value="<?php echo ($mymodual["shuxing_name"]); ?>">
                </div>
              </div>
              <div class="form-row control-group row-fluid">
                <label class="control-label span3" for="normal-field">属性对应类型*</label>
                <div class="controls span7">
                  <input type="text" id="normal-field" class="row-fluid" name="shuxing_type" value="<?php echo ($mymodual["shuxing_type"]); ?>">
                </div>
              </div>
               <div class="form-row control-group row-fluid">
                ...
                <div class="controls span7">
                  ...
                  <input type="radio" name="modual_type" value="0" disabled <?php echo $mymodual["modual_type"]==0?'checked="CHECKED"':''; ?> /> 否 </label>
                  <label class="inline radio">
                  <input type="radio" name="modual_type" value="1" disabled <?php echo $mymodual["modual_type"]==1?'checked="CHECKED"':''; ?> /> 是 </label>
                </div>
                 <div class="controls span3">
               <font>注意高级模型的字段变动不会重新修改数据库表</font>
                </div>
              </div>
             <div class="form-row control-group row-fluid">
                <label class="control-label span3" for="normal-field">数据库中表名(高级模型)</label>
                <div class="controls span7">
                  <input type="text" id="normal-field" class="row-fluid" readonly="readonly"  name="database_table" value="<?php echo ($mymodual["database_table"]); ?>">
                </div>
              </div>
              <div class="form-row control-group row-fluid">
                <label class="control-label span3" for="normal-field">表中对应字段(高级模型)</label>
                <div class="controls span7">
                  <input type="text" id="normal-field" class="row-fluid" name="table_field" value="<?php echo ($mymodual["table_field"]); ?>">
                </div>
              </div>
