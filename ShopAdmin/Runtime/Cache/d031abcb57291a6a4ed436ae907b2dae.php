            ...
            <?php if(is_array($thislist)): $i = 0; $__LIST__ = $thislist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td class="ms">
                <div class="btn-group1">
                  <a target="_blank" class="btn btn-small" rel="tooltip" data-placement="left" data-original-title=" 进入板块管理 "  href="<?php echo U("Product/getlist");?>?type_id=<?php echo ($vo["id"]); ?>"><i class="gicon-edit"></i></a>
