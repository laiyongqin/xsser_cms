...
class NewsModel extends Model{
    ...
    protected $_validate = array(
        array('news_title', 'require', '标题必须填写！', self::MODEL_BOTH),//1为必须验证
        array('news_reco', 'require', '是否推荐必须填写！', self::MODEL_BOTH),
        array("news_reco","/^\d*$/","是否推荐必须是数字！",1,"regex",self::MODEL_BOTH),
        array('news_time', 'require', '发布时间必须填写！', self::MODEL_BOTH),
        array('news_modify_time', 'require', '修改时间必须填写！', self::MODEL_BOTH),
