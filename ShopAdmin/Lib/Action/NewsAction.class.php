...
class NewsAction extends BaseAction {
	...
	public function getnewslist() {
		...
		$this->check_quanxian_module ( $_SESSION ["admin_power"], $this->c_letf_number, 'view' );
		//检验是否具有单页操作权限
		$this->check_quanxian_n ( $_SESSION ["admin_power"], I ( "type_id" ), 'select' );
	...
	public function add() {
		...
		$this->check_quanxian_module ( $_SESSION ["admin_power"], $this->c_letf_number, 'view' );
		//检验是否具有单页操作权限
		$this->check_quanxian_n ( $_SESSION ["admin_power"], I ( "type_id" ), 'add' );
	...
	public function update_info() {
		...
		$this->check_quanxian_module ( $_SESSION ["admin_power"], $this->c_letf_number, 'view' );
		//检验是否具有单页操作权限
		$this->check_quanxian_n ( $_SESSION ["admin_power"], get_nid2news_typeid($_GET ["id"]), 'select' );
	...
	public function update() {
		...
		$this->check_quanxian_module ( $_SESSION ["admin_power"], $this->c_letf_number, 'view' );
		//检验是否具有单页操作权限
		$this->check_quanxian_n ( $_SESSION ["admin_power"], I ( "type_id" ), 'up' );
	...
	public function del() {
		...
		$this->check_quanxian_module ( $_SESSION ["admin_power"], $this->c_letf_number, 'view' );
		//检验是否具有单页操作权限
		$this->check_quanxian_n ( $_SESSION ["admin_power"], get_nid2news_typeid($_GET ["id"]), 'del' );
